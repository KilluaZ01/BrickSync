...
const Setup = () => {
  return (
    <div className="bg-[rgba(34,40,49,1)] flex flex-col justify-center items-center h-screen gap-[60px]">
      ...
      <div className="flex flex-row items-center gap-[60px]">
        <div className="flex flex-col text-[#eee] text-[30px] font-semibold max-w-[190px] items-center text-center ">
